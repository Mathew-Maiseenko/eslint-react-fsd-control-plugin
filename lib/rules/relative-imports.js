	...
	meta: {
		...
		messages: {
			unexpectedNonRelativeImportInsideSlice: `
				Найден неверный импорт: \n
				--------------------------------------\n
				Импорт из: '{{ importPath }}'\n
				Не может быть применен к файлу: '{{ currentFile }}'\n
				--------------------------------------\n
				Причина: неправильное обращение к сущности внутри своего слайса
			`,
			incorrectRelativeImportToSlicesOutsides: `
				Найден неверный относительный импорт: \n
				--------------------------------------\n
				Импорт из: '{{ importPath }}'\n
				Не может быть применен к файлу: '{{ currentFile }}'\n
				--------------------------------------\n
				Причина: неправильное обращение к сторонним слайсам
			`,
